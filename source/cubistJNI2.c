...
JNIEXPORT void JNICALL Java_morphr_MorphR_initiateCubist(JNIEnv *env, jobject thisobject, jstring js){
  FILE *F;
...
JNIEXPORT jdouble JNICALL Java_morphr_MorphR_getPrediction(JNIEnv *env, jobject thisobject, jstring js){
  FILE *F;
  int IValsBase = 0;
  String *Label=Nil;
...
JNIEXPORT jdoubleArray JNICALL Java_morphr_MorphR_getPredictionAndError(JNIEnv *env, jobject thisobject, jstring js){
  int IValsBase = 0;
  String *Label=Nil;
  DataRec ProcessingCase=Nil;
  float ProcessingErr=0.0;
