#include "xtramy_protocols_hybridcertification_oracles_XactAverageExecutionTimes.h"
...
JNIEXPORT jdouble JNICALL Java_xtramy_protocols_hybridcertification_oracles_XactAverageExecutionTimes_getPrediction(JNIEnv *env, jobject thisobject, jstring js){
  FILE *F;
  int IValsBase = 0;
  String *Label=Nil;
...
JNIEXPORT jdoubleArray JNICALL Java_xtramy_protocols_hybridcertification_oracles_XactAverageExecutionTimes_getPredictionAndError(JNIEnv *env, jobject thisobject, jstring js){
  int IValsBase = 0;
  String *Label=Nil;
  DataRec ProcessingCase=Nil;
  float ProcessingErr=0.0;
