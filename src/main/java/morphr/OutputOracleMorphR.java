...
public class OutputOracleMorphR implements OutputOracle {
   ...
   //TODO clean up
   private static String modelFilenameAbort2PC = PropertyReader.getString("modelFilenameAbort2PC", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameThroughput2PC = PropertyReader.getString("modelFilenameThroughput2PC", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameReadOnly2PC = PropertyReader.getString("modelFilenameReadOnly2PC", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameWrite2PC = PropertyReader.getString("modelFilenameWrite2PC", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameAbortPB = PropertyReader.getString("modelFilenameAbortPB", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameThroughputPB = PropertyReader.getString("modelFilenameThroughputPB", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameReadOnlyPB = PropertyReader.getString("modelFilenameReadOnlyPB", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameWritePB = PropertyReader.getString("modelFilenameWritePB", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameAbortTO = PropertyReader.getString("modelFilenameAbortTO", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameThroughputTO = PropertyReader.getString("modelFilenameThroughputTO", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameReadOnlyTO = PropertyReader.getString("modelFilenameReadOnlyTO", "/conf/MorphR/MorphR.properties");
   private static String modelFilenameWriteTO = PropertyReader.getString("modelFilenameWriteTO", "/conf/MorphR/MorphR.properties");
